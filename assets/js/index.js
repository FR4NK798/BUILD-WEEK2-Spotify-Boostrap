window.onload = () => {
  ...
  <footer class="my-14">
    ...
    btnSearchArtist.addEventListener("click", (e) => {
      ...
      col12.innerHTML = `<div class="middle-col">
      <div class="hero-section text-white d-flex flex-column justify-content-between">
        ...
        <div class="p-3">
          ...
          <h1 class="mb-3 fw-bolder">Metric</h1>
          <p>3.549.403 ascoltatori mensili</p>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-12 col-md-7 order-2 order-md-1">
              ...
              <div class="row g-2 mb-3 px-1 px-md-3">
                ...
                <div class="col-10 col-md-6 d-md-flex align-items-center">
              ...
              <div class="row g-2 mb-3 px-1 px-md-3">
                ...
                <div class="col-1 d-flex align-items-center">
                  <div>
                    <img src="./assets/imgs/main/image-13.jpg" alt="copertina" class="w-100" />
                  </div>
                </div>
                <div class="col-10 col-md-6 d-md-flex align-items-center">
                  <div>False Dichotomy</div>
                  <div class="text-secondary d-md-none">2.898.374</div>
                </div>
                <div class="d-none d-md-block col-3 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">2.898.374</div>
                </div>
                <div class="d-none d-md-block col-1 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">3:33</div>
                </div>
              </div>
              <div class="row g-2 mb-3 px-1 px-md-3">
                <div class="col-1 d-flex align-items-center justify-content-center">
                ...
                <div class="col-1 d-flex align-items-center">
                  <div>
                    <img src="./assets/imgs/main/image-14.jpg" alt="copertina" class="w-100" />
                  </div>
                </div>
                <div class="col-10 col-md-6 d-md-flex align-items-center">
                  <div>Risk</div>
                  <div class="text-secondary d-md-none">685.344</div>
                </div>
                <div class="d-none d-md-block col-3 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">685.344</div>
                </div>
                <div class="d-none d-md-block col-1 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">4:58</div>
                </div>
              </div>
              <div class="row g-2 mb-3 px-1 px-md-3">
                <div class="col-1 d-flex align-items-center justify-content-center">
                ...
                <div class="col-1 d-flex align-items-center">
                  <div>
                    <img src="./assets/imgs/main/image-15.jpg" alt="copertina" class="w-100" />
                  </div>
                </div>
                <div class="col-10 col-md-6 d-md-flex align-items-center">
                  <div>Gimme Sympathy</div>
                  <div class="text-secondary d-md-none">1.445.366</div>
                </div>
                <div class="d-none d-md-block col-3 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">1.445.366</div>
                </div>
                <div class="d-none d-md-block col-1 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">3:47</div>
                </div>
              </div>
              <div class="row g-2 mb-3 px-1 px-md-3">
                <div class="col-1 d-flex align-items-center justify-content-center">
                ...
                <div class="col-1 d-flex align-items-center">
                  <div>
                    <img src="./assets/imgs/main/image-16.jpg" alt="copertina" class="w-100" />
                  </div>
                </div>
                <div class="col-10 col-md-6 d-md-flex align-items-center">
                  <div>Breathing Underwater</div>
                  <div class="text-secondary d-md-none">2.325.333</div>
                </div>
                <div class="d-none d-md-block col-3 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">2.325.333</div>
                </div>
                <div class="d-none d-md-block col-1 d-flex align-items-center">
                  <div class="text-secondary d-none d-md-block">3:48</div>
                </div>
              </div>
            </div>
